...
import {BODY, HEADINGS} from '@theme/Fonts'; // Correct font imports
import {COLORS} from '@theme/Colors'; // Assuming correct path for Colors
...
export const onboardingData: SlideType[] = [
  {
    key: '1',
    image: require('./src/assets/images/Onboarding/FirstOnboarding.png'),
  ...
  {
    key: '2',
    image: require('./src/assets/images/Onboarding/SecondOnboarding.png'),
  ...
  {
    key: '3',
    image: require('./src/assets/images/Onboarding/ThirdOnboarding.png'),
